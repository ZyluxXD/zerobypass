...
Proof of concept tool to bypass document replay technology (such as GPT Zero). It uses Playwright automation to type
like a human.
___
...
> educational use, including but not limited to classroom assignments, coursework, exams, tutorials, or any form of formal
...
> consequences, or disciplinary actions that may arise from misuse, including presenting this work in an academic context
